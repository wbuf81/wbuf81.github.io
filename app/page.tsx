...
export default function Home() {
  ...
  const getWanderingPosition = useCallback((time: number) => {
    ...
    // Combine multiple frequencies for organic, non-repetitive movement (1.5x speed)
    const speed = 1.5;
    const x = centerX +
  ...
  return (
    ...
    >
      ...
      <div className="widget widget-bottom-left">
        ...
        <a href="https://www.instagram.com/wb81" target="_blank" rel="noopener noreferrer" className="widget-bottom">
