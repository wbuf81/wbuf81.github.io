    ...
    >
      ...
      <style jsx>{`
        ...
        @keyframes tvstatic {
          ...
          10% { transform: translate(-5%, -3%) scaleX(1.01); }
          20% { transform: translate(3%, 5%) scaleX(0.99); }
          30% { transform: translate(-3%, 2%) scaleX(1); }
          40% { transform: translate(5%, -5%) scaleX(1.01); }
          50% { transform: translate(-2%, 3%) scaleX(0.99); }
          60% { transform: translate(4%, -2%) scaleX(1); }
          70% { transform: translate(-5%, 5%) scaleX(1.01); }
          80% { transform: translate(2%, -3%) scaleX(0.99); }
          90% { transform: translate(-3%, 4%) scaleX(1); }
        }
