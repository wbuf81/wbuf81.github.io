...
const CATEGORY_COLORS: Record<string, { primary: string; secondary: string; glow: string }> = {
  'supplements': { primary: '#10b981', secondary: '#34d399', glow: 'rgba(16, 185, 129, 0.3)' },
  'hair-bath': { primary: '#ec4899', secondary: '#f472b6', glow: 'rgba(236, 72, 153, 0.3)' },
  'food': { primary: '#f59e0b', secondary: '#fbbf24', glow: 'rgba(245, 158, 11, 0.3)' },
  'fitness': { primary: '#8b5cf6', secondary: '#a78bfa', glow: 'rgba(139, 92, 246, 0.3)' },
};
...
function FeaturedCard({ item }: { item: LeeItemType }) {
  const colors = CATEGORY_COLORS[item.category] || CATEGORY_COLORS['supplements'];
    ...
    >
      ...
      <div className="card-content">
        <div className="card-header">
          <span className="category-label">{LEE_CATEGORY_LABELS[item.category]}</span>
...
function ItemCard({ item }: { item: LeeItemType }) {
  const colors = CATEGORY_COLORS[item.category] || CATEGORY_COLORS['supplements'];
    ...
    >
      ...
      <div className="item-content">
        <div className="item-header">
          <span className="category-badge">{LEE_CATEGORY_LABELS[item.category]}</span>
        </div>
...
export default function LeeClient({ items, allTags }: LeeClientProps) {
  const [activeCategory, setActiveCategory] = useState<LeeCategory>('all');
      ...
      <header className="page-header">
        ...
        <div className="hero">
          ...
          <p className="page-subtitle">
            Products Lee actually uses and genuinely recommends.
          ...
          <div className="stats">
            ...
            <span className="stat-divider">•</span>
            <span className="stat">4 categories</span>
          </div>
        </div>
      </header>
      ...
      <div className="filter-bar">
        <div className="filter-bar-inner">
          <div className="category-tabs">
            {(['all', 'supplements', 'hair-bath', 'food', 'fitness'] as LeeCategory[]).map(cat => (
              <button
                key={cat}
        ...
        <div className="results-bar">
          <span className="results-count">
            ...
            {activeCategory !== 'all' && ` in ${LEE_CATEGORY_LABELS[activeCategory]}`}
          </span>
          {showFeatured && (
        ...
        {showFeatured && (
          <section className="featured-section">
            <div className="section-header">
              ...
              <p className="section-subtitle">Lee&apos;s absolute favorites</p>
            </div>
